...
A number of existing software visualisation techniques exist. Common software visualisations include static diagrams~\citetemp{x} and syntax highlighting (see Figure~\ref{fig:syntax-highlighting}). \more

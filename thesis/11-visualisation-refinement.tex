...
\begin{itemize}
\item ``To show relationships between entities, consider linking graphical representations of data objects using lines''~\cite[p.~183]{Ware2013a} \glab{guide:links}

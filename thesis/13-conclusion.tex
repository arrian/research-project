...
% discuss visualisation infrastructure
...
The maturity of the musical nature of live coding also directly impacts visual expressiveness. Music within live coding is far more mature and developed then visualisations and as indicated through these studies, visualisations still have much potential to develop further. It may be that because of the maturity of the musical aspects of live coding, the music influenced perception far more than the visualisations. This was shown in the audience's written survey responses. Responses indicated that issues with the music were more prominent with larger percentages discussing musical limitations over visual limitations.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% discuss the diffferences between the nature of the visualisation and the way it is presented. for example, using two screens or a brighter image could have greatly imporved the results of the follow-up study.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

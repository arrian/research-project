...
Live coding emphasises the concept of \emph{liveness}. The concept of \emph{liveness} is covered comprehensively within the literature~\cite{Auslander,Masura2007} and is foundational to the performance aspect of live coding.\\
...
The literature raises a number of questions and identifies a number of limitations with the current state of research in the visualiston of live code and the limitations of the current methods of software visualisation in general.
% what questions?

...
The first visualisation condition was labelled the ``aesthetic'' condition with an intended goal of improving enjoyment during the live coding performance.

The second visualisation condition was labelled the ``didactic'' condition with an intended goal of improving understanding during the live coding performance.

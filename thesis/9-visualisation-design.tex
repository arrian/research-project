...
A number of guidelines were adapted to develop these visualisations. These guidelines were taken from a variety of sources and included:
\begin{itemize}
...
\item ``Place explanatory text as close as possible to the related parts of a diagram and use a graphical linking method''~\cite[p.~333]{Ware2013a} \glab{guide:close-text}
\end{itemize}

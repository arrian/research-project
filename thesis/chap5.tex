...
\begin{figure}
  ...
  \caption{Class diagram of the visualisation technique employed. The three major components included the visualisation manager, the interface manager and the code manager.}
...
\caption{An example of the visualisation developed.}

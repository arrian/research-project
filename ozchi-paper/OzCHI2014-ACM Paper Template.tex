...
\title{Visualising the Coding Process}
...
Many approaches to visualising software focus on the structure, behaviour or representation of software.  {\color{red}[introduce study + topic]}

{\color{red}[discuss previous work here]}

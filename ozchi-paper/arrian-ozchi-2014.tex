...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{color}% TODO: remove me
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure*}
\centering
\epsfig{file=mean-response.pdf, width=\textwidth}
...
performances. Dramatically, {\color{red}
Figure~\ref{fig:enjoyment-understanding}} shows that a large
proportion of the audience reported low understanding at the beginning
of the performances with the didactic visualisations. One

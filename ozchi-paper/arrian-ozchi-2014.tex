...
Traditional approaches to source code visualisation (see~\cite{Novais2013} for a review) often focus on structure of the source
code (e.g. visualising complex object/class relationships) rather than
the \emph{process} of programming. In a process-oriented activity such
as live coding, different code visualisation techniques are
...
and $56\%$ stated that the didactic visualisations helped (TODO) their
enjoyment. No significant difference between the visualisation types
on enjoyment was found ($\chi^2=3.7733,df=2,p=0.1516$).

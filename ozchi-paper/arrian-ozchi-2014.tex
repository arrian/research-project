...
During the didactic performance, around $20\%$ of the audience moved
from a low understanding to a medium understanding in comparison to
around $10\%$ for the aesthetic visualisations for the same. However,
this reported advantage for the didactic visualisation was offset by a
larger cohort reporting a low understanding at the beginning of the
performance with $44\%$ for the didactic visualisations compared to
$30\%$ for the aesthetic visualisations. Similarly, fewer with the
didactic visualisations reported high understanding both at the
beginning and end of the performance for the didactic visualisations,
with a dramatic difference of $20\%$ with a high understanding at the
end of the performance for the aesthetic visualisations compared to
$5\%$ for the didactic visualisations.
...
\begin{figure}
\centering
\fbox{\epsfig{file=understanding-over-time.pdf, width=0.52\columnwidth}}

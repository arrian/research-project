...
much of their time staring at raw (usually text-based) computer code. In a live coding performance, including those described in this paper, the computer code is central to the audience experience, being projected onto large screens behind the performer.
...
(see~\cite{Novais2013} for a review) often focus on the structure of the
...
are thought to be necessary~\cite{McLean2010b,Magnusson2013}, however, these
...
% \begin{figure}
% \centering
% \epsfig{file=enj-down-up.png, width=0.6\columnwidth}
% \caption{An example of one of the five trajectories presented to the audience during the exploratory field study.}
% \label{fig:field-study-trajectory}
% \end{figure}

% (an example of these can be seen in Figure~\ref{fig:field-study-trajectory})

After a live coding performance at the \emph{You Are Here} arts festival in Canberra, Australia, audience
...
five curves best represented their \emph{enjoyment}
...
Of the thirteen survey responses received (roughly 80\% of the total audience), six audience members showed
...
respondents stated that the code
...
during a live coding performance. The majority of the audience felt that the code made
...
was doing. We were intrigued by the three respondents
...
projections with additional visualisations might give rise to similar responses across the wider audience.
...
A laboratory study was conducted to test the impact of accompanying visualisations on audience understanding
and enjoyment of live coding. Music visualisation is an extremely rich
and open-ended task, so to guide the development of our visualisations, 
we used the concepts of understanding and enjoyment
to develop two new code visualisations: \emph{didactic} and \emph{aesthetic}.
...
The \emph{aesthetic} visualisation technique, was designed
...
Our hypothesis was the didactic visualisation would result in
enhanced audience understanding
through the performance. In contrast, we predicted that the aesthetic
visualisations would positively influence audience enjoyment.
...
\caption{Audience self-reported enjoyment and understanding over the beginning, middle and end of the performance for the aesthetic and didactic conditions.}
...
attempted (as much as possible) to do perform with similar music aesthetic and quality across all performances.
...
``enjoyment'' and ``understanding'', in this case measured as categorical variables of low, medium and high, related to the visualisations
...
between 18 and 32, and $78\%$ had never seen a live
...
\textbf{enjoyment}: $76\%$ stated that the
...
(self-determined) ``beginning'', ``middle'' and ``end'' of the
performances (see Figure~\ref{fig:enjoyment-understanding}). During the didactic
...
performance (see Figure~\ref{fig:enjoyment-understanding}). During the didactic and
...
The overall effect of visualisations on enjoyment was high, for both the
...
The small number of high responses for
...
beginning to middle of the performances perhaps indicate a higher
...
reported to \emph{confuse} some members of the audience, despite their stated
...
The video-cued-recall interview with the live coder indicated that the experience of the
visualisations by the live coder and by audience was fundamentally
...
revealed a generally low to medium level of audience self-reported understanding
...
live coding process. These visualisations
